...
<>
    ...
    <div className="row">
        ...
        <div className="col-md-10">
            <h6 class="mb-0 text-dark"><b>Personal Information for Tinted Permit</b></h6>
            <hr>
            </hr>
        </div>
        <div className="col-md-1 mb-2"></div>
    ...
    <div className="row">
        ...
        <div className="col-md-5 mb-2">
            ...
            <input required type="number" name="nin" placeholder="National Identity Number" class="form-control" id="address"
            value={nin}
